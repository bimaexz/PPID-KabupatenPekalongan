...
<?php
                                    foreach ($this->pages as $page) {
                                        if (!empty($page->page_category) && !empty($page->intro_image)) {
                                            ...
                                            if (strpos($page->intro_image, 'https://') === false
                                                && strpos($page->intro_image, 'http://') === false) {
                                                $introStr .= str_replace(' ', '%20', JUri::root().$page->intro_image);
                                            } else {
...
<?php
                                    ...
                                    foreach ($this->comments as $comment) {
                                        ...
                                        if (empty($avatar)) {
                                            $avatar = gridboxHelper::getUserAvatar($comment->email, 'enable_gravatar');
                                        }
