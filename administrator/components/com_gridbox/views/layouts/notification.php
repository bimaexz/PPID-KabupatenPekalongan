...
$pendingPayments = gridboxHelper::$storeHelper->checkPendingPayments();
?>
...
document.addEventListener('DOMContentLoaded', function(){
    fetch(JUri+'index.php?option=com_gridbox&task=store.pendingPayments').then(function(response){
