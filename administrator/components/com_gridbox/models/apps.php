                ...
                if (isset($map->{'extra_options'})) {
                    ...
                    foreach ($product->extra_options as $extra_option) {
                        ...
                        if (count($array) == 2) {
                            ...
                            if (($object = $extras[$title]) && !isset($extra_options->{$object->ind})) {
                                $obj = new stdClass();
                                $obj->id = $object->id;
                                $obj->items = new stdClass();
                                $extra_options->{$object->ind} = $obj;
                            } else if (($object = $extras[$title])) {
                                $obj = $extra_options->{$object->ind};
                            }
                            if (($object = $extras[$title])) {
                                ...
                                foreach ($list as $li) {
                                    if ($li->title == $array[1]) {
                                        ...
                                        $i = isset($map->{'default_extra'}) ? $map->{'default_extra'} : null;
            ...
            if (isset($fields['extra_options'])) {
                foreach ($page->product->data->extra_options as $id => $obj) {
                    foreach ($obj->items as $item) {
                        $title = array($obj->title, $item->title);
