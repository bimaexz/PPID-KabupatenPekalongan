...
class JmgQuestionnaireControllerQuestion extends JControllerForm
{
	 ...
	 * @since  1.6
	 */
	protected $text_prefix = 'COM_JMGQUESTIONNAIRE_QUESTION';
	...
	public function batch($model = null)
	{
		...
		// Preset the redirect
		$this->setRedirect(JRoute::_('index.php?option=com_jmgquestionnaire&view=question' . $this->getRedirectToListAppend(), false));
	...
	public function answeradd()
	{
		...
		$this->setRedirect(JRoute::_('index.php?option=com_jmgquestionnaire&view=question&layout=edit&id='.$data['questionid'], false));
