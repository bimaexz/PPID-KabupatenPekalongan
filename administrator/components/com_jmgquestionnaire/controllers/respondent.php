...
class JmgQuestionnaireControllerRespondent extends JControllerForm
{
	/**
	 ...
	 * @since  1.6
	 */
	protected $text_prefix = 'COM_JMGQUESTIONNAIRE_RESPONDENT';
	...
	public function batch($model = null)
	{
		...
		// Preset the redirect
		$this->setRedirect(JRoute::_('index.php?option=com_jmgquestionnaire&view=respondent' . $this->getRedirectToListAppend(), false));
