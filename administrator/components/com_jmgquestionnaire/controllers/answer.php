...
class JmgQuestionnaireControllerAnswer extends JControllerForm
{
	/**
	 ...
	 * @since  1.6
	 */
	protected $text_prefix = 'COM_JMGQUESTIONNAIRE_ANSWER';
	...
	public function batch($model = null)
	{
		...
		// Preset the redirect
		$this->setRedirect(JRoute::_('index.php?option=com_jmgquestionnaire&view=answer' . $this->getRedirectToListAppend(), false));
