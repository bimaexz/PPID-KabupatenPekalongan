 ...
 * @since  1.6
 */
class JmgQuestionnaireTableInvitation extends JTable
{
	/**
	...
	{	
		...
		parent::__construct('#__jmgquestionnaire_invitations', 'id', $db);

		$this->setColumnAlias('published', 'state');

		//JTableObserverContenthistory::createObserver($this, array('typeAlias' => 'com_jmgquestionnaire.invitation'));
	}
	...
	public function store($updateNulls = false)
	{
		...
		$table = JTable::getInstance('Invitation', 'JmgQuestionnaireTable', array('dbo' => $this->_db));
