 ...
 * @since  1.6
 */
class JmgQuestionnaireTableRespondent extends JTable
{
	/**
	...
	{	
		...
		parent::__construct('#__jmgquestionnaire_respondents', 'id', $db);

		$this->setColumnAlias('published', 'state');

		//JTableObserverContenthistory::createObserver($this, array('typeAlias' => 'com_jmgquestionnaire.respondent'));
	}
	...
	public function store($updateNulls = false)
	{
		...
		$table = JTable::getInstance('Respondent', 'JmgQuestionnaireTable', array('dbo' => $this->_db));
