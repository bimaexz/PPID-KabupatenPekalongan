 ...
 * @since  1.6
 */
class JmgQuestionnaireTableRecord extends JTable
{
	/**
	...
	{	
		...
		parent::__construct('#__jmgquestionnaire_surveys', 'id', $db);

		$this->setColumnAlias('published', 'state');

		//JTableObserverContenthistory::createObserver($this, array('typeAlias' => 'com_jmgquestionnaire.survey'));
	}
	...
	public function store($updateNulls = false)
	{
		...
		$table = JTable::getInstance('Record', 'JmgQuestionnaireTable', array('dbo' => $this->_db));
