 ...
 * @since  1.6
 */
class JmgQuestionnaireModelRecord extends JModelAdmin
{
	public $typeAlias = 'com_jmgquestionnaire.record';
	...
	*/	
	 ...
	 * @since   1.6
	 */
	public function getTable($type = 'Record', $prefix = 'JmgQuestionnaireTable', $config = array())
	{
	...
	{
		// Get the form.
		$form = $this->loadForm('com_jmgquestionnaire.record', 'record', array('control' => 'jform', 'load_data' => $loadData));
	...
	protected function loadFormData()
	{
		...
		$data = JFactory::getApplication()->getUserState('com_jmgquestionnaire.edit.record.data', array());
		...
		$this->preprocessData('com_jmgquestionnaire.record', $data);
