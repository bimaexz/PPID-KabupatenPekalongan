 ...
 * @since  1.6
 */
class JmgQuestionnaireViewAnswers extends JViewLegacy
{
	...
	public function display($tpl = null)
	{
		...
		JmgQuestionnaireHelper::addSubmenu('answers');
	...
	protected function addToolbar()
	{
		...
		JToolBarHelper::title(JText::_('COM_JMGQUESTIONNAIRE_ANSWERS_TITLE'));
		...
		{
			JToolbarHelper::deleteList('JGLOBAL_CONFIRM_DELETE', 'answers.delete', 'JTOOLBAR_EMPTY_TRASH');
		}
