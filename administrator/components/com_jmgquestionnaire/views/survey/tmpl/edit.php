...
JFactory::getDocument()->addScriptDeclaration('
	...
	{
		if (task == "survey.cancel" || document.formvalidator.isValid(document.getElementById("survey-form")))
		{
...
');
?>
<form action="<?php echo JRoute::_('index.php?option=com_jmgquestionnaire&layout=edit&id=' . (int) $this->item->id); ?>" method="post" name="adminForm" id="survey-form" class="form-validate">
		...
		<div class="<?php echo ($jversion == 3)? 'row-fluid' : 'row'; ?>">
			<div class="span9 col-lg-9">
				<div class="form-horizomtal">
					<?php echo $this->loadTemplate('survey'); ?>
				</div>
			</div>
