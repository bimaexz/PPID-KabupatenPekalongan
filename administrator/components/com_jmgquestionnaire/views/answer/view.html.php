...
/**
 * View to edit a answer.
 *
 * @since  1.5
 */
class JmgQuestionnaireViewAnswer extends JViewLegacy
{
	protected $form;
	protected $item;
	protected $state;
	...
	protected function addToolbar()
	{
		...
		JLoader::register('JmgQuestionnaireHelper', JPATH_ADMINISTRATOR . '/components/com_jmgquestionnaire/helpers/jmgquestionnaire.php');
		JToolbarHelper::title($isNew ? JText::_('COM_JMGQUESTIONNAIRE_ANSWER_NEW_TITLE') : JText::_('COM_JMGQUESTIONNAIRE_ANSWER_EDIT_TITLE'));
		...
		else
		{
			...
			{
				JToolbarHelper::versions('com_jmgquestionnaire.answer', $this->item->id);
			}
