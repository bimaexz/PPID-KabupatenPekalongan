...
JFactory::getDocument()->addScriptDeclaration('
	...
	{
		if (task == "invitation.cancel" || document.formvalidator.isValid(document.getElementById("invitation-form")))
		{
			Joomla.submitform(task, document.getElementById("invitation-form"));
		}
	};
');
?>
<form action="<?php echo JRoute::_('index.php?option=com_jmgquestionnaire&layout=edit&id=' . (int) $this->item->id); ?>" method="post" name="adminForm" id="invitation-form" class="form-validate">
		...
		<div class="<?php echo ($jversion == 3)? 'row-fluid' : 'row'; ?>">
			<div class="span9 col-lg-9">
				<div class="form-horizomtal">
					<?php echo $this->loadTemplate('invitation'); ?>
				</div>
			</div>
