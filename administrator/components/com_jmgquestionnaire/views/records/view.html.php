 ...
 * @since  1.6
 */
class JmgQuestionnaireViewRecords extends JViewLegacy
{
	protected $items;
	...
	public function display($tpl = null)
	{
		...
		JmgQuestionnaireHelper::addSubmenu('records');
	...
	protected function addToolbar()
	{
		...
		JToolBarHelper::title(JText::_('COM_JMGQUESTIONNAIRE_RECORDS_TITLE'));
