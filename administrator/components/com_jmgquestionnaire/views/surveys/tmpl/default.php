...
if ($saveOrder)
{
	$saveOrderingUrl = 'index.php?option=com_jmgquestionnaire&task=surveys.saveOrderAjax&tmpl=component';
...
?>		
<form action="<?php echo JRoute::_('index.php?option=com_jmgquestionnaire&view=surveys'); ?>" method="post" name="adminForm" id="adminForm">
			...
			<table class="table table-striped" id="articleList">
				<thead>
					<tr>
						...
						<th>
							<?php echo JHtml::_('searchtools.sort', 'COM_JMGQUESTIONNAIRE_RESPONDENT', 'respondent', $listDirn, $listOrder); ?>
						</th>
						<th>
							<?php echo JText::_('COM_JMGQUESTIONNAIRE_QUESTIONNAIRE_LABEL'); ?>
						</th>
						<th>
							<?php echo JHtml::_('searchtools.sort', 'COM_JMGQUESTIONNAIRE_COUNT_ANSWERS', 'answers', $listDirn, $listOrder); ?>
						</th>
						<th>
							<?php echo JText::_('JCATEGORY'); ?>
						</th>
						<th width="10%" class="nowrap hidden-phone">
							<?php echo JText::_('COM_JMGQUESTIONNAIRE_LANGUAGE'); ?>
						</th>
						...
						<tr class="row<?php echo $i % 2; ?>" sortable-group-id="<?php echo $item->catid; ?>">
							<td class="has-context">
								<div class="pull-left break-word">
									...
									<?php endif; ?>
									<?php if ($canEdit) : ?>
									<a href="<?php echo JRoute::_('index.php?option=com_jmgquestionnaire&task=survey.edit&id=' . (int) $item->id); ?>">
							...
							<td>
								...
								<?php elseif ($item->invitationid) : ?>
								<?php echo JText::_('COM_JMGQUESTIONNAIRE_INVITED'); ?>
								<?php else : ?>
								<span class="label"><?php echo JText::_('COM_JMGQUESTIONNAIRE_ANONYMOUS'); ?></span>
								<?php endif; ?>
							</td>
							<td>
							...
							<td>
								<?php echo $this->escape($item->answers); ?>
							</td>
							<td>
