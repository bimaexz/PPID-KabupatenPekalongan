jQuery(document).ready(function () {
    ...
    */
    ...
    jQuery('main').prepend('<div class="toggle_fullscreen"> <a href="#" id="toggle_fullscreen"><i class="fa fa-arrows-alt fa-lg" aria-hidden="true"></i></a></div>');

    jQuery('#bfRecordsTableContainer').parent('main').prepend('<div class="toggle_fullscreen_managerecords"> <a href="#" id="toggle_fullscreen_managerecords"><i class="fa fa-arrows-alt fa-lg" aria-hidden="true"></i></a></div>');
