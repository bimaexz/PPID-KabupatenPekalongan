            ...
            <div class="city">
                <div class="city_name">
                    <?php if($params->get('city')==1) { ?>
                        <h4 class="media-heading sp-weather-city"><i class="fa fa-map-marker" aria-hidden="true"></i>
                ...
                <div class="grid grid-<?php echo ($i%2 ? 'even' : 'odd') ?>" style="width:<?php echo round(100/$fcast) ?>%">
                    <div class="media">
                        ...
                        <div class="media-body text-center">
                            <div class="sp-weather-temp">
                                 <?php echo $helper->convertUnit( $value['low'], $data['units']['temperature']) . '&nbsp;' . $params->get('separator') . '&nbsp;' . $helper->convertUnit( $value['high'], $data['units']['temperature']); ?>
                                <!-- <i class="fa fa-long-arrow-down" aria-hidden="true"></i><?php echo $helper->convertUnit( $value['low'], $data['units']['temperature']) ?>
                                <i class="fa fa-long-arrow-up" aria-hidden="true"></i><?php echo $helper->convertUnit( $value['high'], $data['units']['temperature']); ?> -->
                            </div>
                        </div>
                    </div>
                </div>
