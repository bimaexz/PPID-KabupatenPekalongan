...
$cat_trim = trim($this->escape($this->params->get('page_heading')));
...
<div class="blog<?php echo $this->pageclass_sfx; ?>" itemscope itemtype="http://schema.org/Blog">
	...
	<?php if (empty($this->intro_items) && $doc->getBuffer('modules', 'cat-list-add-one', array('style' => 'sp_xhtml')) ) : ?>
		<div class="items-row row clearfix">
			<div class="col-sm-12">
				<?php echo $doc->getBuffer('modules', 'cat-list-add-one', array('style' => 'sp_xhtml')); ?>	
			</div> <!-- /.col-sm- -->
		</div> <!-- /.items-row -->
	<?php endif; ?>
	...
	<?php if (!empty($this->intro_items)) : ?>
		<?php foreach ($this->intro_items as $key => &$item) : ?>
			...
			<?php if ( ($key == ( $tpl_params->get('bl_list_add_one', 3) - 1 ) ) && $doc->countModules('cat-list-add-one') ) { ?>
				<div class="items-row row clearfix">
					<div class="col-sm-12">
					<?php
						jimport( 'joomla.application.module.helper' );
						$modules = JModuleHelper::getModules( 'cat-list-add-one' );
			...
			<?php if ( ($key == ($tpl_params->get('bl_list_add_two', 9) - 1) ) && $doc->countModules('cat-list-add-two') ) { ?>
				<div class="items-row row clearfix">
					<div class="col-sm-12">
						<?php
							jimport( 'joomla.application.module.helper' );
							$modules = JModuleHelper::getModules( 'cat-list-add-two' );
							$attribs['style'] = 'sp_xhtml';
