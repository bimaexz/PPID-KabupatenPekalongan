		...
		<?php if (in_array($child->access, $groups)) : ?>
			...
			<div class="com-content-category-blog__child">
				...
				<h3 class="page-header item-title">
					...
					<?php endif; ?>
					<a href="<?php echo Route::_(GmapfpRoute::getCategoryRoute($child->id, $child->language)).$perso; ?>">
				...
				<?php else : ?>
				<h3 class="page-header item-title"><a href="<?php echo Route::_(GmapfpRoute::getCategoryRoute($child->id, $child->language, 'blog')).$perso; ?>">
					<?php echo $this->escape($child->title); ?></a>
					<?php if ( $this->params->get('show_cat_num_articles', 1)) : ?>
						<span class="badge badge-info">
							<?php echo Text::_('COM_GMAPFP_NUM_ITEMS'); ?>&nbsp;
							<?php echo $child->getNumItems(true); ?>
						</span>
					<?php endif; ?>
