...
class ItemController extends FormController
{
	...
	protected function allowAdd($data = array())
	{
		...
		if ($categoryId)
		{
			...
			$allow = $user->authorise('core.create', 'com_gmapfp.category.' . $categoryId);
		}
	...
	protected function allowEdit($data = array(), $key = 'id')
	{
		...
		if ($user->authorise('core.edit', 'com_gmapfp.item.' . $recordId))
		{
			return true;
		}

		// Check edit own on the record asset (explicit or inherited)
		if ($user->authorise('core.edit.own', 'com_gmapfp.item.' . $recordId))
		{
