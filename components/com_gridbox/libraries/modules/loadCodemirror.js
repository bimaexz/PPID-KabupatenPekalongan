...
file.rel = 'stylesheet';
file.href = codemirrorURI+'/lib/codemirror.css';
document.head.append(file);
file = document.createElement('link');
file.rel = 'stylesheet';
file.href = codemirrorURI+'/theme/material.css';
document.head.append(file);
file = document.createElement('link');
file.rel = 'stylesheet';
file.href = codemirrorURI+'/theme/ttcn.css';
document.head.append(file);
file = document.createElement('script');
file.src = codemirrorURI+'/lib/codemirror.min.js';
document.head.append(file);
file.onload = function(){
    ...
    file = document.createElement('script');
    file.src = codemirrorURI+'/addon/hint/show-hint.min.js';
    document.head.append(file);
    file = document.createElement('script');
    file.src = codemirrorURI+'/addon/hint/css-hint.min.js';
    document.head.append(file);
    file = document.createElement('script');
    file.src = codemirrorURI+'/addon/hint/javascript-hint.min.js';
    document.head.append(file);
    file = document.createElement('script');
    file.src = codemirrorURI+'/mode/css/css.min.js';
    document.head.append(file);
    file.onload = function(){
    ...
    file = document.createElement('script');
    file.src = codemirrorURI+'/mode/javascript/javascript.min.js';
    document.head.append(file);
    file.onload = function(){
    ...
    file = document.createElement('script');
    file.src = codemirrorURI+'/mode/xml/xml.min.js';
    document.head.append(file);
    file.onload = function(){
        file = document.createElement('script');
        file.src = codemirrorURI+'/mode/htmlmixed/htmlmixed.min.js';
        document.head.append(file);
        file.onload = function(){
