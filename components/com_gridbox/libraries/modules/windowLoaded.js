...
app.pageStructure = {
    ...
    getPanel: (create) => {
        let obj = null,
            panel = app.cookie.get('page-structure-panel');
        if (panel) {
            obj = JSON.parse(panel);
        } else if (create) {
            let rect = app.pageStructure.modal[0].getBoundingClientRect();
            obj = {
                visible: app.pageStructure.visible,
                position: '',
                width: rect.width,
                height: rect.height,
                top: rect.top,
    ...
    savePanel: (obj) => {
        ...
        app.cookie.set('page-structure-panel', panel);
    },
    setPanel: (key) => {
    ...
    show: (update) => {
        return new Promise((resolve, reject) => {
            ...
            setTimeout(function(){
                ...
                app.pageStructure.setPanel('visible');
                resolve();
            }, 50);
        });
    },
    ...
    addEvents: () => {
        ...
        app.pageStructure.modal.find('.select-page-structure-position').on('customAction', function(){
            ...
            app.pageStructure.setPanel('position');
        }).on('show', function(){
